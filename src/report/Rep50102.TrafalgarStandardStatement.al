report 50102 "Trafalgar - Standard Statement"
{
    Caption = 'Trafalgar - Customer Statement';
    DefaultLayout = RDLC;
    RDLCLayout = '.\Reports\Layouts\TrafalgarCustomerStatement.rdl';
    dataset
    {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            var
                                Skip: Boolean;
                            begin
                                Clear(YourReferenceText);
                                if CustLedgerEntry.Get("Cust. Ledger Entry No.") then
                                    YourReferenceText := CustLedgerEntry."External Document No.";
                                ...
                                case "Entry Type" of
                                    "Entry Type"::"Initial Entry":
                                        begin
                                            ...
                                            if Skip then
                                                CurrReport.Skip();
                                            YourReference := CustLedgerEntry."External Document No.";
    ...
    var
        ...
        PostDate_DtldCustLedgEntriesCaptionLbl: Label 'Due Date';
