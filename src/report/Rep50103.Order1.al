...
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\Reports\Layouts\TrafalgarPurchaseOrder.rdl';
    Caption = 'Trafalgar Order';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(GSTTotalLbl; GSTTotalLbl)
            {
            }
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(PurchLineInvDiscAmt; -TempPurchaseLine."Inv. Discount Amount")
                        {
                            AutoFormatExpression = "Purchase Line"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(TotalAmtInclVAT; FormattedTotalAmountInclVAT)
                        {
                            AutoFormatExpression = "Purchase Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        begin
                            ...
                            if "Purchase Line".Type = "Purchase Line".Type::Item then begin
                                if ItemL.Get("Purchase Line"."No.") then
                                    if ItemL."Vendor Item No." <> '' then
                                        ItemNo := ItemL."Vendor Item No."
                                    else
                ...
                begin
                    ...
                    FormattedTotalAmountInclVAT := Format(TotalAmountInclVAT, 0, AutoFormat.ResolveAutoFormat(AutoFormatType::AmountFormat, "Purchase Header"."Currency Code"));
            ...
            begin
                if "Purchase Header"."Currency Code" <> '' then begin
                    UnitCostLbl := "Purchase Header"."Currency Code" + ' Unit Cost';
                    TotalLbl := "Purchase Header"."Currency Code" + ' Total';
                    SubTotalLbl := "Purchase Header"."Currency Code" + ' Subtotal:';
                    GSTTotalLbl := "Purchase Header"."Currency Code" + ' GST:';
                    TotalAmountLbl := "Purchase Header"."Currency Code" + ' Total:';
                end else begin
                    UnitCostLbl := 'AUD Unit Cost';
                    TotalLbl := 'AUD Total';
                    SubTotalLbl := 'AUD Subtotal:';
                    GSTTotalLbl := 'AUD GST:';
                    TotalAmountLbl := 'AUD Total:';
                end;
