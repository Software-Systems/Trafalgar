report 50104 "Trafalgar Sales - Invoice"
{
    Caption = 'Trafalgar Sales - Invoice';
    Permissions = tabledata "Sales Shipment Buffer" = rimd;
    PreviewMode = PrintLayout;
    WordMergeDataItem = Header;
    DefaultRenderingLayout = "TrafalgarSalesInvoice.rdlc";
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(Balance_Amount; Format(BalanceAmount, 0, AutoFormat.ResolveAutoFormat(Enum::"Auto Format"::AmountFormat, Header."Currency Code")))
            {
            }
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(LineAmount_Line; Format("Line Amount", 0, AutoFormat.ResolveAutoFormat(Enum::"Auto Format"::AmountFormat, Header."Currency Code")))
                {
                }
                ...
                column(ItemRec; ItemRec."Product Code")
                {
                }
                ...
                column(UnitPriceAfterDiscount; UnitAmtAfterDisText)
                {
                }
                ...
                column(TotalSub_Total; Format(TotalSubTotal, 0, AutoFormat.ResolveAutoFormat(Enum::"Auto Format"::AmountFormat, Header."Currency Code")))
                {
                }
                column(TotalAmount_VAT; Format(TotalAmountVAT, 0, AutoFormat.ResolveAutoFormat(Enum::"Auto Format"::AmountFormat, Header."Currency Code")))
                {
                }
                ...
                begin
                    ...
                    if UnitAmtAfterDiscount <> 0 then
                        UnitAmtAfterDisText := '$' + Format(UnitAmtAfterDiscount, 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, Header."Currency Code"));
    ...
    rendering
    {
        layout("TrafalgarSalesInvoice.rdlc")
        {
            Type = RDLC;
            LayoutFile = '.\Reports\Layouts\TrafalgarSalesInvoice.rdl';
