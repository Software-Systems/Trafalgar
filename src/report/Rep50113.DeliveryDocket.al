report 50113 "Delivery Docket"
{
    Caption = 'Delivery Docket';
    DefaultRenderingLayout = "Trafalgar_DeliveryDocket.rdlc";
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            RequestFilterHeading = 'Delivery Docket';
            ...
            column(unitofmeasure; Line."Unit of Measure Code")
            {
            }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(ShippingAgentCode_Line; "Shipping Agent Code")
                {
                }
                column(ItemProductCode; Item."Product Code")
                {
                }
                ...
                column(ItemProduct; Item."Product Code")
                {
                }
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(TotalQtyOrder; TotalQtyOrder)
                {
                }
                trigger OnPreDataItem()
                var
    ...
    rendering
    {
        layout("Trafalgar_DeliveryDocket.rdlc")
        {
            Type = RDLC;
