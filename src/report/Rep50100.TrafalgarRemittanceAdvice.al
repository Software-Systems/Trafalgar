report 50100 "Trafalgar - Remittance Advice"
{
    DefaultRenderingLayout = "TrafalgarRemittanceAdvice.rdlc";
    Caption = 'Trafalgar - Remittance Advice';
        ...
        dataitem(VendLoop; "Integer")
        {
            ...
            dataitem("Gen. Journal Line"; "Gen. Journal Line")
            {
                ...
                dataitem(PrintLoop; "Integer")
                {
                    ...
                    // MB Trafalgar
                    column(RemainingAmt; -TempAppliedVendLedgEntry."Remaining Amount")
                    {
                    }
                    column(PaidAmnt; PaidAmount)
                    {
                    }
                    // MB Trafalgar
                    trigger OnAfterGetRecord()
    ...
    rendering
    {
        layout("TrafalgarRemittanceAdvice.rdlc")
        {
            Type = RDLC;
            LayoutFile = '.\Reports\Layouts\TrafalgarRemittanceAdvice.rdl';
            Caption = 'Standard Remittance Advice (RDLC)';
            Summary = 'The Standard Remittance Advice (RDLC) provides a detailed layout.';
        }
    }
