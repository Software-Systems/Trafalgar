report 50109 "Trafalgar Sales - Quote"
{
    Caption = 'Trafalgar Sales - Quote';
    PreviewMode = PrintLayout;
    WordMergeDataItem = Header;
    DefaultLayout = RDLC;
    RDLCLayout = '.\Reports\Layouts\TrafalgarSalesQuote.rdl';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(ExternalDocumentNo; "Your Reference")
            {
            }
