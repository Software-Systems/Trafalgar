report 50108 "Trafalgar Transfer Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\Reports\Layouts\TrafalgarTransferOrder.rdl';
    Caption = 'Trafalgar Transfer Order';
        ...
        dataitem("Transfer Header"; "Transfer Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(TransferToCode; "Transfer Header"."Transfer-to Code")
                    { }
                    column(TransferFromCode; "Transfer Header"."Transfer-from Code")
                    { }
                    column(TransferFromName; "Transfer Header"."Transfer-From Name")
                    { }
                    column(TransferToName; "Transfer Header"."Transfer-To Name")
                    { }
