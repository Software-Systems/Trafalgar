report 50112 "Sales Quote"
{
    Caption = 'Sales Quotation';
    DefaultRenderingLayout = "Trafalgar_StandardSalesQuote.rdlc";
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(LineAmount_Line; TextLineAmount)
                {
                }
                ...
                begin
                    ...
                    Clear(TextLineAmount);
                    if "Line Amount" <> 0 then
                        TextLineAmount := '$' + Format("Line Amount", 0, AutoFormat.ResolveAutoFormat(AutoFormatType::UnitAmountFormat, CurrencyCode));
            ...
            dataitem(Totals; "Integer")
            {
                ...
                begin
                    ...
                    TotalAmtPaid := Format((TotalAmountInclVAT - Header."Amount Paid"), 0, AutoFormat.ResolveAutoFormat(AutoFormatType::AmountFormat, CurrencyCode));
                end;
            }
    ...
    rendering
    {
        layout("Trafalgar_StandardSalesQuote.rdlc")
        {
            Type = RDLC;
            LayoutFile = '.\Reports\Layouts\Trafalgar_StandardSalesQuote.rdl';
