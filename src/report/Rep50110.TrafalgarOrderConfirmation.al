report 50110 TrafalgarOrderConfirmation
{
        ...
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                begin
                    ...
                    //AmountPaidText := '$ ' + Format(Header."Amount Paid");
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(TotalAmountToBePaid; TotalAmountInclVAT - Header."Amount Paid")
                {
                }
    ...
    rendering
    {
        layout("StandardSalesOrderConf.rdl")
        {
            Type = RDLC;
            LayoutFile = '.\Reports\Layouts\TrafalgarStandardSalesOrderConf.rdl';
